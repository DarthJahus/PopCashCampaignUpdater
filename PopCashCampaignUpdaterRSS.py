...
if __name__ == "__main__":
    ...
    while True:
        for _website in __config["websites"]:
            ...
            new_article_available, article_id = check_new_article_in_rss(__config["websites"][_website])
            if new_article_available:
                if pc_increase_campaign_budget(__config["websites"][_website]["campaign_id"], __config["websites"][_website]["api_key"], __config["websites"][_website]["budget_delta"]):
